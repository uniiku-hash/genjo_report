...
ui_units_developing = st.text_input("改善されたが完全に定着はしていない単元・課題（任意）", placeholder="例：図形の証明")
...
ui_next_phase = st.selectbox(f"{next_class_month}以降の通常授業", ["学校の予習", "◆◆対策"])
...
ui_next_phase_teaching_material = st.text_input("使用予定の教材（任意）", placeholder="例：入試過去問")

current_grade_nensei = {"小1": "小学1年生", "小2": "小学2年生", "小3": "小学3年生", "小4": "小学4年生", "小5": "小学5年生", "小6": "小学6年生", "中1": "中学1年生", "中2": "中学2年生", "中3": "中学3年生", "高1": "高校1年生", "高2": "高校2年生", "高3": "高校3年生"}
target_states = {
    "6月": "今年中",
    "11月": f"{current_grade_nensei[grade]}",
    "2月": "新学年",
}[season]
ui_target_state = st.text_input(f"{target_states}で目指す状態", placeholder="例：自立して学習できるようになる")
...
- 【学ぶチカラ】について、「A：テスト本番力を身につける」や、「B：丸つけの間違いをなくす」など、具体的な課題が与えられた場合、それを文章に反映してください。
- 【学ぶチカラ】について、学ぶチカラBが未入力の場合は、関連する文章を一切生成しないでください。


## テンプレート選択指示
以下は、時期ごとのテンプレートです。
あなたは以下のテンプレートA～Cの中から、面談時期に囚われすぎずに、最適な言葉を選び、内容を生成してください。

---
### テンプレートA：6月面談用（時期：夏 / 振り返り：春期講習）
【現在の学習状況および克服課題】
●春期講習では【入力された単元】を学びました。はじめは～（Before）だったのが、～（After）までできるようになりました。ここで学んだことは、現在の学習につながっています。【改善中の単元】は改善傾向ですが、まだ定着には至っていないため、時期をおいて復習する予定です。●克服単元としては、【克服単元1】（理解度、定着度）、【克服単元2】などが挙げられます。また、今後高めていく学習力として「A：【学ぶチカラ課題1】」「B：【学ぶチカラ課題2】」が挙げられます。●現在、授業は【授業状況】で進めていて、【進捗】です。（遅れている場合は理由も記述）

【今後の指導計画および目標】
●テスト後、通常授業では予習を進めていきます。【カリキュラム終了時期】に終わる予定です。【今後の方針】として【使用教材】などに取り組んでいきます。●克服課題の【克服単元1】などは家庭学習や【克服場所】で反復していきます。●学習力については、「A：【学ぶチカラ指導案1】」「B：【学ぶチカラ指導案2】」に取り組んでいきましょう。●新学年では、【目指す状態】という状態を目指して取り組んでいきます。

---
### テンプレートB：11月面談用（時期：冬 / 振り返り：夏期講習）
【現在の学習状況および克服課題】
●夏期講習では【入力された単元】を学びました。はじめは～（Before）だったのが、～（After）までできるようになりました。これは～という成果につながりました。【改善中の単元】は改善されましたが、入試に向けて復習が必要です。●克服単元としては、【克服単元1】（理解度、定着度）などが挙げられます。また、今後高めていく学ぶチカラとして「A：【学ぶチカラ課題1】」「B：【学ぶチカラ課題2】」が挙げられます。●現在、【授業状況】で進めていて、【進捗】です。（遅れている場合は理由も記述）

【今後の指導計画および目標】
●後期中間テスト後、通常授業では予習を進めていきます。内容は【カリキュラム終了時期】に終わる予定です。その後は【今後の方針】に入ります。【使用教材】などにも取り組んでいきます。●克服課題の【克服単元1】などは【克服場所】で、冬期講習などで復習し、入試レベルまで引き上げます。●学ぶチカラについては、「A：【学ぶチカラ指導案1】」「B：【学ぶチカラ指導案2】」に取り組んでいきましょう。●新学年では、【目指す状態】という状態を目指して取り組んでいきます。

---
### テンプレートC：2月面談用（時期：春 / 振り返り：冬期講習）
【現在の学習状況および克服課題】
●冬期講習では【入力された単元】の理解を深め、～（After）の状態になりました。（Beforeにも触れる）。課題として【改善中の単元】などが残っています。●それ以外の克服課題として、【克服単元1】（理解度、定着度）などが挙げられます。また、今後高めていく学ぶチカラとして「A：【学ぶチカラ課題1】」「B：【学ぶチカラ課題2】」が挙げられます。●現在、【授業状況】で進めていて、【進捗】です。（遅れている場合は理由も記述）

【今後の指導計画および目標】
●3月以降、学校内容を扱う時間は調整し、【今後の方針】を中心に行います。【使用教材】などを使用予定です。●克服課題の【克服単元1】は【克服場所】で、【克服単元2】は春期講習で復習していきましょう。●学ぶチカラについては「A：【学ぶチカラ指導案1】」「B：【学ぶチカラ指導案2】」に取り組んでいきましょう。●次学年になる前に、自覚と生活習慣を確立することを目指します。●新学年では、【目指す状態】という状態を目指して取り組んでいきます。
"""
...
- 今後の方針: {ui_next_phase}
- 使用教材: {ui_next_phase_teaching_material}
- 目指す状態: {ui_target_state}
"""
...
if button_situation_and_plan:
    ...
    required_fields = [
        ...
        (ui_next_phase, "今後のスケジュール"),
        (ui_target_state, "目指す状態"),
    ]
    if (power_of_learning_category2):
...
st.warning("学習状況および指導計画をコピー&ペーストをしてから生成しましょう")
